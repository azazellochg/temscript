...
# ---------------- FEI Gatan Remoting enums -----------------------------------


class AcquisitionProcessingOption(IntEnum):
    """ Image correction for GMS detectors. """
    UNPROCESSED = 1
    DARK_SUBTRACTED = 2
    GAIN_NORMALIZED = 3


class AcquisitionReadMode(IntEnum):
    """ GMS detectors acquisition mode. """
    LINEAR = 0
    COUNTING = 1
    COUNTING_AND_SUPERRESOLUTION = 2


class FractionFileFormat(IntEnum):
    """ File format for saving GMS images."""
    MRC_STACK = 0
    MULTIPAGE_TIFF = 1
    MULTIPAGE_TIFF_LZW = 2


class PixelFormat(IntEnum):
    """ Pixel format for GMS images. """
    Unknown = 0
    UInt4 = 1
    UInt8 = 2
    UInt16 = 3
...
class TransposeSetting(IntEnum):
    """ Image rotation for GMS. """
    RotateNoneFlipNone = 0
    RotateNoneFlipX = 1
    RotateNoneFlipY = 2
    RotateNoneFlipXY = 3
    Rotate90FlipNone = 258
    Rotate90FlipX = 256
    Rotate90FlipY = 259
    Rotate90FlipXY = 257
    Rotate180FlipNone = 3
    ...
    Rotate180FlipY = 1
    Rotate180FlipXY = 0
    Rotate270FlipNone = 257
    Rotate270FlipX = 259
    Rotate270FlipY = 256
    Rotate270FlipXY = 258
    DigitalMicrograph = 65535


class AcquisitionEventIds(IntEnum):
    """ Events TFS <-> Gatan? """
    ShuttingDown = 1
    ExposureFinished = 2
